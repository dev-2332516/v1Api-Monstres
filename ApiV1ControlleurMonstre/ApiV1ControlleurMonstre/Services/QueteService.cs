...
namespace ApiV1ControlleurMonstre.Services
{
    public class QueteService : BackgroundService
    {
                    ...
                    do
                    {
                        switch (Random.Shared.Next(3))
                        {
                            ...
                            case 0:
                                ...
                                allQuests.Add(queteDestination);
                                break;
                            // Monstre
                            case 1:
                            ...
                            case 2:
                                ...
                                allQuests.Add(queteNiveau);
                                break;
                        }
                    } while (allQuests.Where(quest => quest.Personnage == character).ToList().Count() < 3);
                }
        ...
        private async Task VerifyCompletion(MonsterContext context, CancellationToken cancellationToken)
        {
            ...
            if (allQuests.Any(item => item.EstCompleter == true))
            {
        ...
        {
            TimeSpan _checkInterval = TimeSpan.FromMinutes(10); // Check every 10 minutes
